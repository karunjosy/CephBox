...
function singleHostDeployment() {
  ...
  cephadm --image $(ceph_image) bootstrap --mon-ip $(get_pvt_ipaddress)  --single-host-defaults | tee /root/ceph_install.out
